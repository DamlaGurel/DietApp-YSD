    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 10, 13, 25, 18, 841, DateTimeKind.Local).AddTicks(3241), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 170.0, false, 3000.0, 70.0, 2000.0, "ahmet", 80.0, 1, "mehmet", 18 },
                    { 2, new DateTime(2024, 2, 10, 13, 25, 18, 841, DateTimeKind.Local).AddTicks(3256), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 170.0, false, 3000.0, 70.0, 2000.0, "ahmet", 80.0, 2, "mehmet", 18 },
                    { 3, new DateTime(2024, 2, 10, 13, 25, 18, 841, DateTimeKind.Local).AddTicks(3259), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 170.0, false, 3000.0, 70.0, 2000.0, "ahmet", 80.0, 3, "mehmet", 18 },
                    { 4, new DateTime(2024, 2, 10, 13, 25, 18, 841, DateTimeKind.Local).AddTicks(3260), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 170.0, false, 3000.0, 70.0, 2000.0, "ahmet", 80.0, 4, "mehmet", 18 },
                    { 5, new DateTime(2024, 2, 10, 13, 25, 18, 841, DateTimeKind.Local).AddTicks(3261), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 170.0, false, 3000.0, 70.0, 2000.0, "admin", 80.0, 5, "adminoğlu", 18 }
                });
